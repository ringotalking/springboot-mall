package com.ringo.springbootmall.dao.impl;
...
import com.ringo.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        Integer totol = namedParameterJdbcTemplate.queryForObject(sql, map, Integer.class);
    ...
    public List<Product> getProducts(ProductQueryParams productQueryParams) {
        //String sql = "SELECT product_id, product_name, category, image_url, price, stock, description, created_date, last_modified_date FORM product";
